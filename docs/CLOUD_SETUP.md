...
기본 발송 시간은 한국 시간 화요일~토요일 오전 9시입니다. 월요일~금요일 미국장 마감 보고서를 다음 날 아침에 보냅니다. GitHub Actions의 정각 예약이 밀리지 않도록 8시 55분에 작업을 시작해 보고서를 먼저 배포하고, 발송 단계에서 9시까지 기다린 뒤 카카오톡을 보냅니다. GitHub 자체가 9시 이후에 작업을 시작한 날에는 더 기다리지 않고 준비가 끝나는 즉시 보냅니다.
